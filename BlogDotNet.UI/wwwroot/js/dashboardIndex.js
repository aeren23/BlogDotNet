$(document).ready(function () {
    ...
    $.ajax({
        ...
        error: function () {
            toastr.error("Makale analizi yüklenemedi","Hata!")
        }
    });
    ...
    $.ajax({
        ...
        error: function () {
            toastr.error("kategori analizi yüklenemedi", "Hata!")
        }
    });
        ...
        success: function (data) {
            ...
            const totalRevenueChartEl = document.querySelector('#customTotalRevenueChart'),
                totalRevenueChartOptions = {
                    ...
                    xaxis: {
                        categories: ['Ocak', 'Subat', 'Mart', 'Nisan', 'Mayis', 'Haziran', 'Temmuz', 'Agustos', 'Eylül', 'Ekim', 'Kasim', 'Aralik'],
                        labels: {
                            style: {
                                fontSize: '13px',
                                colors: axisColor

...
namespace BlogDotNet.ServiceLayer.Describer
{
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        public override IdentityError PasswordRequiresUniqueChars(int uniqueChar)
        {
            return new IdentityError { Code = "PasswordRequiresUniqueChars", Description = $"Şifre en az {uniqueChar} karakter içermelidir." };
        }
